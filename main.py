...
real_events 3~10개, existing_works 3~10개."""
        r = client.messages.create(model="claude-sonnet-4-6",max_tokens=3000,temperature=0.3,system=sys,messages=[{"role":"user","content":user}],tools=[{"type":"web_search_20250305","name":"web_search"}])
